...
SOURCE="./src/*.cpp ./src/GameWorld/*.cpp ./src/GameWorld/enums/*.cpp"
...
# ARGUMENTS="-std=c++11 -shared -undefined dynamic_lookup"

# Which directories do we want to include.
INCLUDE_DIR="-I ./include/ -I./pybind11/include/   -I/Library/Frameworks/SDL2.framework/Headers  -I/Library/Frameworks/SDL2_ttf.framework/Headers -I/Library/Frameworks/SDL2_mixer.framework/Headers `python3.11 -m pybind11 --includes`"

# What libraries do we want to include
LIBRARIES="-F/Library/Frameworks -rpath /Library/Frameworks  -framework SDL2_ttf -framework SDL2_mixer -framework SDL2 `python3.11-config --ldflags`"
